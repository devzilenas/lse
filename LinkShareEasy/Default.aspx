    ...
    <div class="row">
        <div class="col-md-4">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton CssClass="btn btn-default" ID="OptionsButton" runat="server" href="#options" Text="🔧" />
                </span>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton CssClass="btn btn-success" ID="WhatIsIt1" runat="server" Text="&nbsp;?&nbsp;" />
                </span>
            </div>
